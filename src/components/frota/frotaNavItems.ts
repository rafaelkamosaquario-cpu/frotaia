...
export const FROTA_NAV_ITEMS: FrotaNavItem[] = [
  ...
  { href: "/frota/fretes", label: "Fretes / Análises", icon: HandCoins, disponivel: true },
  ...
  { href: "/frota/jornadas", label: "Jornadas", icon: Clock3, disponivel: true },
  { href: "/frota/rotas", label: "Rotas salvas", icon: MapPin, disponivel: true },
