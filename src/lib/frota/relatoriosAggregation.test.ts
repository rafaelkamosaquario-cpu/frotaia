...
import { resolvePeriodo, filterRelatoriosInput, type RelatoriosInput } from "./relatoriosAggregation";
...
describe("filterRelatoriosInput", () => {
  ...
  it("dados vazios não quebram (todos os blocos ficam vazios, sem erro)", () => {
    const vazio: RelatoriosInput = { veiculos: [], motoristas: [], manutencoes: [], documentos: [], despesas: [], jornadas: [], checklistDispatches: [], analisesFrete: [] };
