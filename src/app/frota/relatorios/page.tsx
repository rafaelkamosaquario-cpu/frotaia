...
export default async function RelatoriosPage({
  ...
  const [veiculos, motoristas, manutencoes, documentos, despesas, receitas, jornadas, checklistDispatches, analisesFrete] = await Promise.all([
    ...
    listExpenses(supabase, { companyId: access.company.id, vehicleId, dateFrom: periodo.from, dateTo: periodo.to, all: true }),
    listRevenues(supabase, { companyId: access.company.id, vehicleId, dateFrom: periodo.from, dateTo: periodo.to, all: true }),
