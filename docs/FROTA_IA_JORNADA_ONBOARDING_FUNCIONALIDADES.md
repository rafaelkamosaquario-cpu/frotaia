...
>
> **ATUALIZAÇÃO 2026-08-26 (rodada seguinte, ainda no mesmo dia — Guia de Primeiros Passos, V1+V2)**: novo recurso opcional, distinto do onboarding — só começa depois que o cliente já está liberado, nunca bloqueia nada, sempre pode ser pulado/reaberto. V1 (WhatsApp): 6 passos determinísticos oferecidos uma única vez após o cadastro, comando permanente pra reabrir. V2 (Painel): tour visual de 8 passos com spotlight na primeira entrada no dashboard, mais ajuda contextual num subconjunto de telas. Guia ≠ onboarding: nenhuma etapa do cadastro foi tocada. Detalhe completo: `docs/FROTA_IA_GUIA_PRIMEIROS_PASSOS.md`.
